...
If you have already made your bot application, you can skip this document and move on to [`initial-files`](../getting-started/initial-files.mdx).
...
3. Click on the `New Application` button.
    ...
    <br />
    <p align = "center">
        <img src="./images/new-application.png" alt="New Application button" width="40%"/>
    </p>
    <br />
...
4. Give the application a name and click `Create`.
    ...
    <br />
    <p align = "center">
        <img src="./images/application-name.png" alt="Create Application modal" width="60%"/>
    </p>
    <br />
...
5. Create a Bot User by navigating to the `Bot` tab and clicking `Add Bot`.
    ...
    <br />
    <p align = "center">
        <img src="./images/build-a-bot.png" alt="Build-A-Bot" width="75%"/>
    </p>
    <br />
...
6. Make sure that `Public Bot` is ticked if you want others to invite your bot.
    ...
    <br />
    <p align = "center">
        <img src="./images/new-bot.png" alt="New Bot" width="75%"/>
    </p>
    <br />
...
[initial files](../getting-started/initial-files.mdx) page of the guide, we cover how to safely store your token
...
<br />
<p align = "center">
    <img src="./images/system-message.png" alt="System message" width="75%"/>
</p>
<br />
...
<br />
<p align = "center">
    <img src="./images/system-dm.png" alt="System DM" width="50%"/>
</p>
<br />
