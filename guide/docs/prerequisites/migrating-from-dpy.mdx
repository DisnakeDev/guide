...
After the discontinuation of `discord.py` (refer [this gist](https://gist.github.com/Rapptz/4a2f62751b9600a31a0d3c78100287f1)), many forks of the API wrapper branched
...
in your code. You can refer [this page](https://gist.github.com/apple502j/f75b4f24652f04de85c7084ffd73ec58) for the full list of breaking changes in `discord.py 2.0`,
