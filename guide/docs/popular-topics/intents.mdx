...
No matter which disnake version you use, you will be required to turn on the message_content intent in the [discord development portal](https://discord.com/developers/applications).
