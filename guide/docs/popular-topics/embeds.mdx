...
<DocsLink reference="disnake.Embed.set_thumbnail">set_thumbnail</DocsLink> attribute.
...
<DocsLink reference="disnake.Embed.add_field">add_field</DocsLink> attribute. It is also possible to use markdown in both
parameters.
...
<DocsLink reference="disnake.Embed.insert_field_at">embed.insert_field_at(index, ...)</DocsLink>.
...
<DocsLink reference="disnake.Embed.from_dict">Embed.from_dict()</DocsLink> method. We can recreate the embed made at the
start of this page, using the same.
