...
You can use the [`Embed`](https://docs.disnake.dev/en/latest/api.html#embed) instance for the creation and manipulation of
embeds.
...
<sup>Source: <a href="https://discordjs.guide/popular-topics/embeds.html#notes">Discord.js Guide</a></sup>
...
<sup>Source: <a href="https://discord.com/developers/docs/resources/channel#embed-limits">Discord API Documentation</a></sup>
