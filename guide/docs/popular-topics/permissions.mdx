...
not something you'd usually use often, they can make your bot developer job a lot easier when it comes to complex
permission math you'd have to do manually otherwise.
