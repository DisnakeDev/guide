...
project documentation. The package utilized for Discord-like message elements is [`@skyra/discord-components-react`](https://www.npmjs.com/package/@skyra/discord-components-react).
