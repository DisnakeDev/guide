...
**Slash Commands** is one of the types of [**Interactions**](/interactions) an application can create. It provides users a first-class way to interact with your bot.
