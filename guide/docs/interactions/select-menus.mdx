...
-   <DocsLink reference="disnake.ui.UserSelect">disnake.ui.UserSelect</DocsLink> User or Member objects as options (Note:
    Options for this type of Select are populated by Discord) */}
-   <DocsLink reference="disnake.ui.RoleSelect">disnake.ui.RoleSelect</DocsLink> Role objects as options (Note: Options for
    this type of Select are populated by Discord) */}
-   <DocsLink reference="disnake.ui.ChannelSelect">disnake.ui.ChannelSelect</DocsLink> Channel objects as options (Note:
    Options for this type of Select are populated by Discord) */}
