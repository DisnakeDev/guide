...
start coding and get it online! Let's start by creating a `.env` file for your bot token and a main file for your bot
application.
...
:::info Online editors (Glitch, Replit, etc.)
...
This is how you create a bot instance for your Discord bot and login to Discord. Open your terminal and run
